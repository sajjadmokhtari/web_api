...
// @Success 201 {object} dto.CountryResponse "File response"
...
func (h *FileHandler) Create(c *gin.Context) {
	...
	if err != nil {
		c.AbortWithStatusJSON(helper.TranslateErrorStatusCode(err), helper.GenerateBaseResponseWithError(nil, false, helper.InternalError, err))
...
// @Success 200 {object} dto.FileResponse "File response"
// @Failure 400 {object} helper.BaseHttpResponse "Bad Request"
// @Router /files/{id} [put]
// @Security AuthBearer
...
func (h *FileHandler) Delete(c *gin.Context) {
	...
	if id == 0 {
		c.AbortWithStatusJSON(http.StatusNotFound, helper.GenerateBaseResponse(nil, false, helper.ValidationError))
		return
	}
...
// @Produce json
// @Param id path int true "Id"
// @Success 200 {object} helper.BaseHttpResponse "File Response"
// @Failure 400 {object} helper.BaseHttpResponse "Bad Request"
// @Router /files/{id} [get]
// @Security AuthBearer
...
// @Success 200 {object} helper.BaseHttpResponse "file response"
// @Failure 400 {object} helper.BaseHttpResponse "Bad Request"
// @Router /files/get-by-filter [post]
// @Security AuthBearer
